...
public extension Http {
    ...
    func printSuccess (_ httpObject: HttpObject) {
        do {
            ...
            DispatchQueue.main.async {
                ...
                if let json = parsedData as? NSDictionary {
                    if json.number("success").intValue == 2 {
    ...
    public class func alert (_ ttl: String?, _ msg: String?) {
        ...
        /*if ttl != nil {
         ttl = kAppDelegate.getLang (ttl!)
         }
         
         if msg != nil {
         msg = kAppDelegate.getLang (msg!)
         }*/
    ...
    public class func alertAction (_ btns: [Any], _ index: Int) -> UIAlertAction {
        let title = (btns[index + 1] as? String)!
