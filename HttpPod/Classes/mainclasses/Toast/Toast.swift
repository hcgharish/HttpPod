...
public class Toast: UIView {
    let blackview = UILabel(frame: UIScreen.main.bounds)
        ...
        DispatchQueue.main.async {
            ...
            if app?.window != nil {
                if msg.count > 0 {
                    ...
                    view.backgroundColor = UIColor.hexColor(0x4f4f4f)
                    ...
                    self.blackview.backgroundColor = UIColor.hexColor(0x2C3237).withAlphaComponent(0.4)
