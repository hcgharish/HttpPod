...
public class DotLoader: NSObject {
    ...
    public var dotColor = UIColor.hexColor(0xff9800)
    ...
    func createContainerView() {
        ...
        self.container?.border6(dotSize / 2)
...
extension UIView {
        ...
        DispatchQueue.global().async {
            ...
            while stopped == false {
                DispatchQueue.main.async {
                    ...
                    self.frame = frame
                    self.center = center
                    self.border6(frame.size.height/2)
                }
                usleep(UInt32(time))
            }
        }
    ...
    func border6(_ radious: CGFloat) {
        self.layer.masksToBounds = true
        //self.layer.borderColor = UIColor.white.cgColor
        self.layer.cornerRadius = radious
    ...
    func border0(_ radious: CGFloat) {
        self.layer.masksToBounds = true
        self.layer.borderColor = UIColor.white.cgColor
        self.layer.cornerRadius = radious
        self.layer.borderWidth = 0
